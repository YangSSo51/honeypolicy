...
with open('db_column.csv','r',encoding="utf-8-sig") as fin: # `with` statement available in 2.5+
    ...
    to_db = [(i['title'], i['body'], i['age'],i['educated'],i['region'],i["url"],randomDate("2019-01-01", "2019-6-30", random.random()),randomDate("2019-01-01", "2019-6-30", random.random()),randomDate("2019-7-1","2020-12-31", random.random()),0,"admin") for i in dr]
